...
class trt_pose_hand_prediction(object):
	def __init__(self):
		...
		# Publisher
		self.predict_images = rospy.Publisher("trt_pose_hand/prediction_image", Image, queue_size = 1)
...
if __name__ == '__main__': 
	rospy.init_node('trt_pose_hand_prediction',anonymous=False)
	trt_pose_hand_prediction = trt_pose_hand_prediction()
	rospy.on_shutdown(trt_pose_hand_prediction.onShutdown)
	rospy.spin()
